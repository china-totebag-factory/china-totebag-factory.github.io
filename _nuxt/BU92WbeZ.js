...
`,await navigator.clipboard.writeText(n),typeof window<"u"&&window.$toast&&window.$toast.success("Success","Order details copied to clipboard!"),g()}catch(n){console.error("Failed to copy to clipboard:",n),typeof window<"u"&&window.$toast&&window.$toast.error("Error","Failed to copy to clipboard")}},C=()=>{const n=`
    <!DOCTYPE html>
    <html>
    <head>
