...
`,await navigator.clipboard.writeText(n),typeof window!="undefined"&&window.$toast&&window.$toast.success("Success","Order details copied to clipboard!"),g()}catch(n){console.error("Failed to copy to clipboard:",n),typeof window!="undefined"&&window.$toast&&window.$toast.error("Error","Failed to copy to clipboard")}},$=()=>{const n=`
    <!DOCTYPE html>
    <html>
    <head>
